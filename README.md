...
## Como começar
  ...
  - Consulte a pasta "**libUnicornio/docs**". L� voc� encontra o arquivo "**libUnicornio - Documentacao.html**", que contem um link para a documenta��o da biblioteca.
  - Consulte tamb�m os [Projetos de exemplo](https://github.com/GuilhermeAlanJohann/libUnicornio-projetos_de_exemplo). Eles ajudam a entender como usar as funcionalidades mais b�sicas da biblioteca. 
