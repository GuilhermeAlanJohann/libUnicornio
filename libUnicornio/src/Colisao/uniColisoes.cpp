...
bool uniColisaoLinhaComRetangulo(float linha_x1, float linha_y1, float linha_x2, float linha_y2, float retan_x, float retan_y, float retan_rot, float retan_largura, float retan_altura, float retan_ancora_x, float retan_ancora_y)
{
	Vetor2D canto_retan;
...
bool uniColisaoCirculoComRetangulo(float circulo_x, float circulo_y, float raio, float retan_x, float retan_y, float retan_rot, float retan_largura, float retan_altura, float retan_ancora_x, float retan_ancora_y, bool testar_dentro)
{
	Vetor2D canto_retan;
	canto_retan.x = -retan_ancora_x*retan_largura;
	canto_retan.y = -retan_ancora_y*retan_altura;
...
bool uniColisaoRetanguloComRetangulo(float x1, float y1, float rot1, float largura1, float altura1, float ancora_x1, float ancora_y1, float x2, float y2, float rot2, float largura2, float altura2, float ancora_x2, float ancora_y2, bool testar_dentro)
{
...
bool uniColisaoRetanguloComPoligono(float retan_x, float retan_y, float retan_rot, float retan_largura, float retan_altura, float retan_ancora_x, float retan_ancora_y, Vetor2D* pontos, int num_pontos, float poli_x, float poli_y, float poli_rot, bool testar_dentro)
{
	Vetor2D retan[4];
