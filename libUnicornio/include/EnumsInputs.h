...
enum UNI_API EnumBotaoJoystickXbox
{
	...
	BOTAO_XBOX_B = SDL_CONTROLLER_BUTTON_B,
	BOTAO_XBOX_X = SDL_CONTROLLER_BUTTON_X,
	BOTAO_XBOX_Y = SDL_CONTROLLER_BUTTON_Y,
	BOTAO_XBOX_VOLTAR = SDL_CONTROLLER_BUTTON_BACK,
	BOTAO_XBOX_GUIA = SDL_CONTROLLER_BUTTON_GUIDE,
	BOTAO_XBOX_START = SDL_CONTROLLER_BUTTON_START,
	BOTAO_XBOX_L3 = SDL_CONTROLLER_BUTTON_LEFTSTICK,
	BOTAO_XBOX_R3 = SDL_CONTROLLER_BUTTON_RIGHTSTICK,
	BOTAO_XBOX_LB = SDL_CONTROLLER_BUTTON_LEFTSHOULDER,
	BOTAO_XBOX_RB = SDL_CONTROLLER_BUTTON_RIGHTSHOULDER,
	BOTAO_XBOX_CIMA = SDL_CONTROLLER_BUTTON_DPAD_UP,
	BOTAO_XBOX_BAIXO = SDL_CONTROLLER_BUTTON_DPAD_DOWN,
	BOTAO_XBOX_ESQ = SDL_CONTROLLER_BUTTON_DPAD_LEFT,
	BOTAO_XBOX_DIR = SDL_CONTROLLER_BUTTON_DPAD_RIGHT,
	NUMERO_DE_BOTOES_XBOX = SDL_CONTROLLER_BUTTON_MAX
};
/*
Só para manter o numero maximo de botoes em um multipo/potencia de 2.
*/
...
/*     SDL_SCANCODE_LOCKINGSCROLLLOCK = 132, */
    ...
    TECLA_APLICACAO_PROCURAR = SDL_SCANCODE_AC_SEARCH,
    TECLA_APLICACAO_HOME = SDL_SCANCODE_AC_HOME,
    TECLA_APLICACAO_VOLTAR = SDL_SCANCODE_AC_BACK,
    TECLA_APLICACAO_AVANCAR = SDL_SCANCODE_AC_FORWARD,
    TECLA_APLICACAO_PARAR = SDL_SCANCODE_AC_STOP,
    TECLA_APLICACAO_REFRESH = SDL_SCANCODE_AC_REFRESH,
    TECLA_APLICACAO_BOOKMARKS = SDL_SCANCODE_AC_BOOKMARKS,
