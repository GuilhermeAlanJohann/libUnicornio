...
public:
	...
	int	getLarguraOriginal();	//	n�o escalado
	int	getAlturaOriginal();	//	n�o escalado
	int	getLarguraLinha(int linha);				//	escalado
	int	getAlturaLinha(int linha);				//	escalado
	int	getLarguraOriginalLinha(int linha);		//	n�o escalado	
	int	getAlturaOriginalLinha(int linha);		//	n�o escalado	
	int	getCorVermelho();
	int	getCorVerde();
	int	getCorAzul();
	int	getCorAlpha();
	...
	void obterTamanhoOriginal(int &larg, int &alt);					//	n�o escalado
	void obterTamanhoLinha(int linha, int &larg, int &alt);			//	escalado		
	void obterTamanhoOriginalLinha(int linha, int &larg, int &alt);	//	n�o escalado	
